...
public class xia extends JFrame {
	...
	public xia() {
		...
		comboBox.setFont(new Font("свт╡", Font.PLAIN, 18));
		...
		btnp.setFont(new Font("свт╡", Font.PLAIN, 18));
